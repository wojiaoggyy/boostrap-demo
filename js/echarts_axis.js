...
var myChart_03 = echarts.init(document.getElementById('chart_03'));
var myChart_04 = echarts.init(document.getElementById('chart_04'));
var myChart_05 = echarts.init(document.getElementById('chart_05'));
var myChart_06 = echarts.init(document.getElementById('chart_06'));
var myChart_17 = echarts.init(document.getElementById('chart_17'));
var myChart_18 = echarts.init(document.getElementById('chart_18'));
var data_option_0 = [
	[
...
var options_18 = {
    ...
    series: [{
        ...
        data: [{
            ...
            value: 8844,
            symbol: 'image://../json/Echarts/hill-Qomolangma.png',
            symbolSize: ['200%', '105%'],
            symbolPosition: 'end',
            z: 10
        }, {
            value: 5895,
            symbol: 'image://../json/Echarts/hill-Kilimanjaro.png',
            symbolSize: ['200%', '105%'],
            symbolPosition: 'end'
        }],
        markLine: {
...
myChart_01.setOption(options_01);

myChart_03.setOption(options_03);
myChart_04.setOption(options_04);
myChart_05.setOption(options_05);
myChart_06.setOption(options_06);

myChart_17.setOption(options_17);
myChart_18.setOption(options_18);
